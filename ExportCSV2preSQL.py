...
qdemo ='''load data local infile '/ix1/mladi/work/cler/data/_demo.csv' into table mladi23.EMR_demo \
...
qloc = '''load data local infile '/ix1/mladi/work/cler/data/_loc.csv' into table mladi23.EMR_loc \
fields terminated by ',' optionally enclosed BY '\"' ignore 1 LINES  \
...
qce ='''load data local infile '/ix1/mladi/work/cler/data/_ce.csv' into table mladi23.EMR_ce \
fields terminated by ',' optionally enclosed BY '\"' ignore 1 lines \
...
qlab = '''load data local infile '/ix1/mladi/work/cler/data/_lab.csv' into table mladi23.EMR_lab \
fields terminated by ','  OPTIONALLY ENCLOSED BY '\"' ignore 1 LINES \
...
qio = '''load data local infile '/ix1/mladi/work/cler/data/_io.csv' into table mladi23.EMR_io \
fields terminated by ',' optionally enclosed BY '\"' ignore 1 lines \
...
qmed = '''load data local infile '/ix1/mladi/work/cler/data/_med.csv' into table mladi23.EMR_meds \
fields terminated by ',' optionally enclosed BY '\"' ignore 1 lines \
...
qicd = '''load data local infile '/ix1/mladi/work/cler/data/_icd.csv' into table mladi23.EMR_icd \
fields terminated by ',' optionally enclosed BY '\"' ignore 1 lines \
(RowNumber,@dat,Study_id,FIN_Study_Id,DX_IND,TYPE,CODE_TYPE,SEQ,CONFIRM_STAT,DISP,LIFE_CYCLE,SOURCE,CODE) SET \
CHART_DATE = str_to_date(@dat, '%Y-%m-%d %H:%i:%s') , \
UTCoffset = CAST(substring(@dat,25,3) AS SIGNED) '''

qpatient = '''load data local infile '/ix1/mladi/work/cler/data/_patient.csv' into table mladi23.EMR_patient \
fields terminated by ',' optionally enclosed by '\"' ignore 1 lines \
...
qalerts = '''load data local infile '/ix1/mladi/work/cler/data/_alert.csv' into table mladi23.DWC_alert \
fields terminated by ',' optionally enclosed BY '\"' ignore 1 lines \
( \
...
qmicro = '''load data local infile '/ix1/mladi/work/cler/data/_micro.csv' into table mladi23.EMR_micro \
fields terminated by ',' optionally enclosed by '\"' ignore 1 lines \
...
qsurg = '''load data local infile '/ix1/mladi/work/cler/data/_surg.csv' into table mladi23.EMR_surg \
fields terminated by ',' optionally enclosed by '\"' ignore 1 lines \
...
qdlce = '''load data local infile '/ix1/mladi/work/cler/data/_dialysis_ce.csv' into table mladi23.EMR_dl_ce \
fields terminated by ',' optionally enclosed by '\"' ignore 1 lines \
...
qdldt = '''load data local infile '/ix1/mladi/work/cler/data/_dl_details_recent.csv' into table mladi23.EMR_dl_dt \
fields terminated by ',' optionally enclosed by '\"' ignore 1 lines \
...
qsuscept = '''load data local infile '/ix1/mladi/work/cler/data/_suscep.csv' into table mladi23.EMR_suscept \
fields terminated by ',' optionally enclosed by '\"' ignore 1 lines \
...
qcsce = '''load data local infile '/ix1/mladi/work/cler/data/_cs_ce.csv' into table mladi23.EMR_cs_ce \
fields terminated by ',' optionally enclosed by '\"' ignore 1 lines \
(RowNumber,study_id,FIN_study_id,@EVENT_DATE,EVENT_NAME,EVENT_TAG,RESULT_VAL) \
SET \
event_date = str_to_date(concat(left(@EVENT_DATE_DATE,23),'000'), '%Y-%m-%d %H:%i:%s.%f'), \
UTCoffset = cast(SUBSTRING(@valid_DATE,25,3) AS SIGNED) '''
